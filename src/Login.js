      ...
      <div className="contentsLogin">
        <div className="banner">
          ...
          <p className="subtitle">
            로그인을 하시면 CAMPER의 다양한 서비스를 이용하실 수 있습니다.
          </p>
        </div>
        <div className="form">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-check">
              <div className="check">
                <label for="id_save">
                  <input type="checkbox" id="idSaveCheck" ref={register} />
                  아이디 저장
                </label>
              </div>
        ...
        <div className="btn-area">
          <p className="btn-subtitle">아직 CAMPER 계정이 없으신가요?</p>
          <div className="btn-wrap">
            ...
            <button className="kakao-login" onClick={kakaoLoginClickHandler}>
              카카오톡으로 로그인
            </button>
          </div>
        </div>
